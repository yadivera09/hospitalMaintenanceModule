        ...
        <div className="space-y-6">
            ...
            <div className="flex items-start justify-between gap-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-xl font-bold text-tinta leading-none">Roles</h1>
                            ...
                            <TableRow>
                                <TableCell colSpan={4} className="py-16 text-center">
                                    <div className="flex flex-col items-center justify-center">
                                        <ShieldCheck className="h-8 w-8 text-borde mb-3" />
                                        <p className="text-sm text-tinta-tenue">No hay roles configurados.</p>
                                    </div>
                                </TableCell>
                            </TableRow>
                        ) : (
                                ...
                                >
                                    ...
                                    <TableCell className="py-3.5 pl-5">
                                        <div className="flex items-center gap-2">
                                            {rol.es_sistema && (
                                                <Lock className="h-3.5 w-3.5 text-tinta-tenue shrink-0" aria-label="Rol de sistema" />
                                            )}
                                    ...
                                    <TableCell className="py-3.5 hidden md:table-cell">
                                        <span className="text-sm text-tinta-media truncate max-w-[300px] block">
                                            {rol.descripcion ?? <span className="text-tinta-tenue italic">Sin descripción</span>}
                                        </span>
                                    </TableCell>
            ...
            <Dialog open={modalCrearAbierto} onOpenChange={(open) => !open && cerrarModalCrear()}>
                <DialogContent className="max-w-md">
                    <DialogHeader>
                        <DialogTitle className="text-tinta">Nuevo Rol</DialogTitle>
                    ...
                    <form onSubmit={handleCrearRol} className="space-y-4 mt-2">
                        ...
                        <div className="space-y-1.5">
                            <label htmlFor="rol-nombre" className="text-sm font-medium text-tinta">
                            ...
                            <input
                                ...
                                className="w-full rounded-md border border-borde bg-panel px-3 py-2 text-sm text-tinta placeholder:text-tinta-tenue focus:outline-none focus:ring-2 focus:ring-marca-linea focus:border-marca"
                            />
                        </div>

                        {/* Descripción */}
                        <div className="space-y-1.5">
                            <label htmlFor="rol-descripcion" className="text-sm font-medium text-tinta">
                            ...
                            <textarea
                                ...
                                rows={3}
                                className="w-full rounded-md border border-borde bg-panel px-3 py-2 text-sm text-tinta placeholder:text-tinta-tenue focus:outline-none focus:ring-2 focus:ring-marca-linea focus:border-marca resize-none"
                            />
                        </div>

                        {/* Nota: es_sistema nunca se puede asignar */}
                        <p className="text-xs text-tinta-tenue bg-panel-suave rounded-md px-3 py-2 border border-borde">
            ...
            >
                <DialogContent className="max-w-sm">
                    <DialogHeader>
                        <DialogTitle className="text-tinta">Eliminar rol</DialogTitle>
                        <DialogDescription className="text-tinta-tenue">
                    ...
                    <p className="text-sm text-tinta-media">
                        ...
                        <strong className="text-tinta">{modalEliminarRol?.nombre}</strong>?
